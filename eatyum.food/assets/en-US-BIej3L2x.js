...
const K = 6048e5, G = 864e5, Z = 6e4, $ = 36e5, tt = 43200, et = 1440;
let b = {};
function nt() {
  return b;
}
function at(t) {
  const n = y(t), e = new Date(Date.UTC(n.getFullYear(), n.getMonth(), n.getDate(), n.getHours(), n.getMinutes(), n.getSeconds(), n.getMilliseconds()));
...
function d(t) {
  return (n, e) => {
    ...
    if (a === "formatting" && t.formattingValues) {
      const r = t.defaultFormattingWidth || t.defaultWidth, i = e != null && e.width ? String(e.width) : r;
      o = t.formattingValues[i] || t.formattingValues[r];
    } else {
      const r = t.defaultWidth, i = e != null && e.width ? String(e.width) : t.defaultWidth;
...
function c(t) {
  return (n, e = {}) => {
    const a = e.width, o = a && t.matchPatterns[a] || t.matchPatterns[t.defaultMatchWidth], s = n.match(o);
    if (!s) return null;
    const r = s[0], i = a && t.parsePatterns[a] || t.parsePatterns[t.defaultParseWidth], h = Array.isArray(i) ? N(i, (l) => l.test(r)) : O(i, (l) => l.test(r));
    let u;
    u = t.valueCallback ? t.valueCallback(h) : h, u = e.valueCallback ? e.valueCallback(u) : u;
...
function V(t) {
  return (n, e = {}) => {
    ...
    if (!a) return null;
    const o = a[0], s = n.match(t.parsePattern);
    if (!s) return null;
...
const q = /^(\d+)(th|st|nd|rd)?/i, z = /\d+/i, I = {
  narrow: /^(b|a)/i,
