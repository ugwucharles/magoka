...
function de({ popup: t, outlets: l, onSubmit: C, loading: g, title: u, description: c }) {
  var _a;
  const [i, x] = o.useState({ title: (t == null ? void 0 : t.title) || "", imageUrl: (t == null ? void 0 : t.imageUrl) || "", linkRoute: (t == null ? void 0 : t.linkRoute) || "", isActive: (_a = t == null ? void 0 : t.isActive) != null ? _a : true, outletIds: (t == null ? void 0 : t.outlets.map((r) => r.id)) || [] }), w = (r) => {
