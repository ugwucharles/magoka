...
function Le() {
  ...
  const { user: i, loading: z } = Q(), { toast: l } = J(), [m, C] = k.useState(false), [E, M] = k.useState("1000"), [N, x] = k.useState(false), { data: r, isLoading: ie, error: ne } = ee(), { data: t, isLoading: P, isError: b, refetch: R } = T({ queryKey: ["/api/wallet"], enabled: !!i }), { data: a, isLoading: w } = T({ queryKey: ["/api/referrals"], enabled: !!i }), v = () => a != null && a.referralCode ? `https://magoka.food/r/${a.referralCode}` : "", h = () => __async(null, null, function* () {
    ...
    if (s) if (navigator.share) try {
      yield navigator.share({ title: `Join magoka and get ${y((r == null ? void 0 : r.amountInNaira) || 2e3)} bonus!`, text: `Use my referral link to sign up for magoka and get ${y((r == null ? void 0 : r.amountInNaira) || 2e3)} bonus after your first order of \u20A61500+`, url: s });
    } catch (e2) {
      h();
    }
    else h();
    ...
    try {
      ...
      window.PaystackPop.setup({ key: "pk_live_51d38ad85ab130cafa9cd8d675f62374d2193b91", email: (i == null ? void 0 : i.email) || `wallet${(i == null ? void 0 : i.id) || "user"}@magoka.food`, amount: s * 100, ref: V.reference, currency: "NGN", callback: function(_) {
