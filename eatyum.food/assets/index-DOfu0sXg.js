...
const jE = [{ slug: "bigmouthchops", name: "BigMouthChops", domain: "bigmouthchops.com", basePath: "/bigmouthchops", supportEmail: "support@bigmouthchops.com", logoUrl: null, colorScheme: "#c2410c" }], ey = jE.map((e) => __spreadProps(__spreadValues({}, e), { basePath: LE(e.basePath), domain: DE(e.domain) }));
function LE(e) {
  const t = e.trim();
  if (!t) return "";
...
const ME = (e) => e ? e.startsWith("/") ? e : `/${e}` : "/", rl = (e) => {
  ...
  var n, r;
  return { item_id: ((n = e.id) == null ? void 0 : n.toString()) || "", item_name: e.name || "", category: ((r = e.category) == null ? void 0 : r.name) || "Food", price: Number(e.price || 0) / 100 || 0, quantity: t, currency: "NGN", item_brand: "magoka", item_variant: e.description ? e.description.substring(0, 50) : void 0 };
  ...
  window.gtag("event", "purchase", { transaction_id: e, value: n / 100, currency: "NGN", coupon: i, shipping: r / 100, tax: 0, affiliation: s || "magoka", items: l });
}, zP = (e, t, n) => {
