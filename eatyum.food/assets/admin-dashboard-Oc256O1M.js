...
function gn() {
  ...
  const Z = () => {
    ...
    return a === "outlets" ? e.jsx(Zt, {}) : a === "categories" ? e.jsx(sa, {}) : a === "products" ? e.jsx(ia, {}) : a !== "dashboard" ? e.jsxs("div", { className: "space-y-6", children: [e.jsx("h2", { className: "text-3xl font-bold capitalize", children: a }), e.jsxs("div", { className: "text-center py-12", children: [e.jsxs("p", { className: "text-gray-500 dark:text-gray-400 text-lg", children: [a.charAt(0).toUpperCase() + a.slice(1), " management coming soon"] }), e.jsxs("p", { className: "text-sm text-gray-400 dark:text-gray-500 mt-2", children: ["This section will include comprehensive ", a, " management tools"] })] })] }) : e.jsxs("div", { className: "space-y-6", children: [e.jsxs("div", { className: "flex flex-col gap-4 md:flex-row md:items-center md:justify-between", children: [e.jsx("h2", { className: "text-3xl font-bold", children: "Dashboard" }), e.jsxs("div", { className: "flex items-center gap-3", children: [e.jsxs(ye, { value: i, onValueChange: (l) => {
      ...
      const L = l.icon;
      return e.jsx(Ze, { permission: l.permission, children: e.jsxs(Y, { children: [e.jsxs(re, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [e.jsx(xe, { className: "text-sm font-medium", children: l.title }), e.jsx(L, { className: `h-4 w-4 ${l.color}` })] }), e.jsxs(G, { children: [e.jsx("div", { className: "text-2xl font-bold", children: l.value }), e.jsx("p", { className: "text-xs text-gray-500 dark:text-gray-400", children: l.description })] })] }) }, l.title);
    }) }), e.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [e.jsx(Ze, { permission: "viewDailyAnalytics", children: q() ? e.jsxs(Y, { children: [e.jsxs(re, { children: [e.jsx(xe, { children: "Daily Analytics (Last 7 Days)" }), e.jsx(we, { children: "Track signups, orders, delivered orders, and sales by day" })] }), e.jsx(G, { children: g ? e.jsx("div", { className: "space-y-2", children: [...Array(7)].map((l, L) => e.jsx("div", { className: "h-12 bg-gray-200 animate-pulse rounded" }, L)) }) : w && w.length > 0 ? e.jsxs(Tt, { children: [e.jsx(Dt, { children: e.jsxs(Zs, { children: [e.jsx(Pe, { children: "Date" }), e.jsx(Pe, { className: "text-center", children: "Signups" }), e.jsx(Pe, { className: "text-center", children: "Orders" }), e.jsx(Pe, { className: "text-center", children: "Delivered" }), e.jsx(Pe, { className: "text-center", children: "Conv. Rate" }), e.jsx(Pe, { className: "text-center", children: "Conv. %" }), e.jsx(Ze, { permission: "viewSalesData", children: e.jsx(Pe, { className: "text-right", children: "Sales" }) })] }) }), e.jsx(Rt, { children: w.map((l) => {
      const L = l.dailyOrders > 0 ? l.delivered / l.dailyOrders : 0, Q = L * 100;
      return e.jsxs(Zs, { children: [e.jsx(Oe, { className: "font-medium", children: l.formattedDate }), e.jsx(Oe, { className: "text-center", children: l.signups }), e.jsx(Oe, { className: "text-center", children: l.dailyOrders }), e.jsx(Oe, { className: "text-center", children: l.delivered }), e.jsx(Oe, { className: "text-center", children: e.jsxs("span", { className: L > 0.8 ? "text-green-600" : L > 0.5 ? "text-yellow-600" : "text-red-600", children: [l.delivered, "/", l.dailyOrders] }) }), e.jsx(Oe, { className: "text-center", children: e.jsxs("span", { className: Q > 80 ? "text-green-600" : Q > 50 ? "text-yellow-600" : "text-red-600", children: [Q.toFixed(1), "%"] }) }), e.jsx(Ze, { permission: "viewSalesData", children: e.jsxs(Oe, { className: "text-right", children: ["\u20A6", l.totalSales.toLocaleString()] }) })] }, l.date);
    }) })] }) : e.jsx("div", { className: "text-center py-8 text-gray-500", children: "No daily analytics data available" }) })] }) : e.jsxs(Y, { children: [e.jsxs(re, { children: [e.jsx(xe, { children: "Recent Orders" }), e.jsx(we, { children: "Latest customer orders" })] }), e.jsx(G, { children: e.jsx("div", { className: "space-y-4", children: f == null ? void 0 : f.recentOrders.map((l) => e.jsxs("div", { className: "flex items-center justify-between p-3 border rounded-lg", children: [e.jsxs("div", { children: [e.jsx("p", { className: "font-medium", children: l.orderNumber }), e.jsx("p", { className: "text-sm text-gray-500", children: l.customerName })] }), e.jsxs("div", { className: "text-right", children: [e.jsxs("p", { className: "font-medium", children: ["\u20A6", l.totalAmount] }), e.jsx("p", { className: `text-xs px-2 py-1 rounded-full ${l.status === "completed" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`, children: l.status })] })] }, l.id)) }) })] }) }), e.jsxs("div", { className: "space-y-6", children: [e.jsxs(Y, { children: [e.jsxs(re, { children: [e.jsx(xe, { children: "Quick Actions" }), e.jsx(we, { children: "Common admin tasks" })] }), e.jsx(G, { children: e.jsxs("div", { className: "space-y-3", children: [e.jsx("div", { className: "p-3 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer", children: e.jsxs("div", { className: "flex items-center", children: [e.jsx(Be, { className: "h-4 w-4 mr-3 text-blue-600" }), e.jsx("span", { children: "Add New Product" })] }) }), e.jsx("div", { className: "p-3 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer", children: e.jsxs("div", { className: "flex items-center", children: [e.jsx(bs, { className: "h-4 w-4 mr-3 text-green-600" }), e.jsx("span", { children: "Add New Outlet" })] }) }), e.jsx("div", { className: "p-3 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer", children: e.jsxs("div", { className: "flex items-center", children: [e.jsx(er, { className: "h-4 w-4 mr-3 text-purple-600" }), e.jsx("span", { children: "View Analytics" })] }) })] }) })] }), R && e.jsxs(Y, { children: [e.jsxs(re, { children: [e.jsxs(xe, { className: "flex items-center justify-between", children: [e.jsx("span", { children: "Pending Payout Approvals" }), e.jsx(Ae, { variant: "outline", children: (_a = O == null ? void 0 : O.count) != null ? _a : 0 })] }), e.jsx(we, { children: "Awaiting admin OTP approval (transfer not yet initiated)" })] }), e.jsx(G, { children: y ? e.jsx("div", { className: "text-sm text-gray-500", children: "Loading pending approvals..." }) : O && O.items.length > 0 ? e.jsx("div", { className: "space-y-2", children: O.items.map((l) => e.jsxs("div", { className: "p-3 border rounded-md", children: [e.jsxs("div", { className: "flex items-center justify-between", children: [e.jsxs("div", { className: "text-sm font-medium", children: ["#", l.orderNumber] }), e.jsxs("div", { className: "text-sm font-semibold", children: ["\u20A6", (l.amountKobo / 100).toLocaleString("en-NG")] })] }), e.jsx("div", { className: "text-xs text-gray-600 mt-1", children: l.riderName || "Rider not set" }), e.jsx("div", { className: "text-xs text-gray-500", children: l.submittedAt ? new Date(l.submittedAt).toLocaleString() : "Submitted" })] }, l.payoutId)) }) : e.jsx("div", { className: "text-sm text-gray-500", children: "No pending payout approvals." }) })] })] })] })] });
  };
