...
function Le() {
  ...
  const m = () => x != null && x.referralCode ? `https://magoka.food/r/${x.referralCode}` : "", f = () => __async(null, null, function* () {
    const t = m();
    if (t) try {
    ...
    const t = m(), o = `\u{1F37D}\uFE0F Join me on magoka and get ${l((s == null ? void 0 : s.amountInNaira) || 2e3)} bonus! Use my referral link: ${t} - Earn ${l((s == null ? void 0 : s.amountInNaira) || 2e3)} after your first order of \u20A61500+. Real magoka. \u{1F525}`;
    ...
    if (navigator.share) try {
      yield navigator.share({ title: `Join magoka and get ${l((s == null ? void 0 : s.amountInNaira) || 2e3)} bonus!`, text: `Use my referral link to sign up for magoka and get ${l((s == null ? void 0 : s.amountInNaira) || 2e3)} bonus after your first order of \u20A61500+`, url: t });
    } catch (e2) {
      f();
    }
    else f();
