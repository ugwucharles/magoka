...
function R() {
  ...
  return e.jsx("div", { className: "min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900", children: e.jsxs(N, { className: "w-full max-w-md", children: [e.jsxs(S, { className: "space-y-1", children: [e.jsx(b, { className: "text-2xl font-bold text-center", children: "EatYum Admin Panel" }), e.jsx(E, { className: "text-center", children: "Sign in to access the admin dashboard" })] }), e.jsx(k, { children: e.jsxs("form", { onSubmit: y, className: "space-y-4", children: [e.jsxs("div", { className: "space-y-2", children: [e.jsx(u, { htmlFor: "email", children: "Email" }), e.jsx(m, { id: "email", type: "email", placeholder: "admin@eatyum.food", value: o, onChange: (s) => h(s.target.value), required: true })] }), e.jsxs("div", { className: "space-y-2", children: [e.jsx(u, { htmlFor: "password", children: "Password" }), e.jsxs("div", { className: "relative", children: [e.jsx(m, { id: "password", type: a ? "text" : "password", placeholder: "Enter your password", value: l, onChange: (s) => p(s.target.value), required: true }), e.jsx("button", { type: "button", onClick: () => x(!a), className: "absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200", "aria-label": a ? "Hide password" : "Show password", children: a ? e.jsx(I, { className: "w-4 h-4" }) : e.jsx(P, { className: "w-4 h-4" }) })] })] }), e.jsx(L, { type: "submit", className: "w-full", disabled: d, children: d ? "Signing in..." : "Sign In" })] }) })] }) });
}
export { R as default };
