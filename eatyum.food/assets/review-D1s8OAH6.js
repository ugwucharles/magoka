...
function W() {
  ...
  const d = i.data;
  return d.expiredMessage ? e.jsx("div", { className: "min-h-screen flex items-center justify-center bg-gray-50 p-4", children: e.jsxs("div", { className: "text-center max-w-sm", children: [e.jsx(R, { className: "w-12 h-12 text-amber-400 mx-auto mb-4" }), e.jsx("h2", { className: "text-lg font-semibold text-gray-800 mb-2", children: "Link Expired" }), e.jsx("p", { className: "text-gray-500 text-sm", children: d.expiredMessage })] }) }) : d.alreadyCompleted ? e.jsx("div", { className: "min-h-screen flex items-center justify-center bg-gray-50 p-4", children: e.jsxs("div", { className: "text-center max-w-sm", children: [e.jsx(N, { className: "w-12 h-12 text-green-500 mx-auto mb-4" }), e.jsx("h2", { className: "text-lg font-semibold text-gray-800 mb-2", children: "Already Submitted" }), e.jsxs("p", { className: "text-gray-500 text-sm", children: ["You've already submitted your feedback for order #", d.orderNumber, ". Thank you!"] })] }) }) : e.jsxs("div", { className: "min-h-screen bg-gray-50 flex items-center justify-center p-4", children: [e.jsx("div", { className: "fixed top-0 left-0 right-0 h-1 bg-red-600 z-10" }), e.jsxs("div", { className: "w-full max-w-md", children: [e.jsx("div", { className: "text-center mb-6", children: e.jsx("span", { className: "inline-block bg-red-600 text-white font-bold text-lg px-4 py-1.5 rounded-full tracking-tight", children: "EatYum" }) }), e.jsxs("div", { className: "bg-white rounded-3xl shadow-lg border border-gray-100 p-6", children: [t === "welcome" && e.jsx(Y, { outletName: d.outletName, orderNumber: d.orderNumber, onStart: () => c(1) }), typeof t == "number" && e.jsx(D, { category: h, rating: l[h], onChange: (o) => g(h, o), onNext: () => {
