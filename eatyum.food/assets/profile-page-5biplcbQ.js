...
function Ne() {
  const { user: s, isAuthenticated: r } = Q(), { toast: t } = q(), { data: l } = E(), { data: n } = O(), { data: a, isLoading: x } = J({ queryKey: ["/api/profile"], enabled: r }), o = () => {
    if (a != null && a.referralCode) {
      const m = `https://magoka.food/r/${a.referralCode}`;
      navigator.clipboard.writeText(m), t({ title: "Copied!", description: "Referral link copied to clipboard" });
    }
  }, c = () => {
    if (a != null && a.referralCode) {
      const m = `https://magoka.food/r/${a.referralCode}`, y = C((n == null ? void 0 : n.amountInNaira) || 2e3), w = `Join magoka and get ${y} off your first order! Use my referral link: ${m}`;
      navigator.share ? navigator.share({ title: `Join magoka - Get ${y} Off!`, text: w, url: m }) : (navigator.clipboard.writeText(w), t({ title: "Copied!", description: "Referral message copied to clipboard" }));
    }
  };
  ...
  return e.jsxs("div", { className: "min-h-screen bg-gray-50", children: [e.jsx("header", { className: "bg-white shadow-sm sticky top-0 z-40", children: e.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: e.jsxs("div", { className: "flex items-center justify-between h-16", children: [e.jsx("div", { className: "flex items-center", children: e.jsx(u, { href: "/", children: e.jsxs(d, { variant: "ghost", size: "sm", className: "flex items-center gap-2", children: [e.jsx(A, { className: "h-4 w-4" }), "Back to Home"] }) }) }), e.jsx(u, { href: "/", className: "flex items-center", children: e.jsx("img", { src: "/magoka-logo.png", alt: "magoka Logo", className: "h-10" }) }), e.jsx("div", { className: "w-24" }), " "] }) }) }), e.jsxs("div", { className: "max-w-4xl mx-auto p-4 py-8", children: [e.jsxs("div", { className: "text-center mb-8", children: [e.jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "My Profile" }), e.jsx("p", { className: "text-gray-600", children: "Manage your account and preferences" })] }), e.jsx(g, { className: "mb-6", children: e.jsxs(L, { className: "text-center pb-4", children: [e.jsxs("div", { className: "mx-auto", children: [e.jsxs(Y, { className: "w-20 h-20 mx-auto mb-4", children: [e.jsx(B, { src: "" }), e.jsx(H, { className: "text-white text-xl", style: { backgroundColor: (l == null ? void 0 : l.colorScheme) || "#F02819" }, children: a != null && a.fullName ? f(a.fullName) : "U" })] }), e.jsx("h2", { className: "text-xl font-semibold", children: a == null ? void 0 : a.fullName }), e.jsx("p", { className: "text-gray-600", children: (a == null ? void 0 : a.email) || (a == null ? void 0 : a.phone) || "Add your contact details" })] }), (a == null ? void 0 : a.referralCode) && e.jsxs("div", { className: "mt-6 p-4 bg-green-50 rounded-lg border border-green-200", children: [e.jsxs("div", { className: "flex items-center justify-center gap-2 mb-3", children: [e.jsx(S, { className: "h-5 w-5 text-green-600" }), e.jsx("span", { className: "font-medium text-green-800", children: "Your Referral Link" })] }), e.jsxs("div", { className: "flex items-center gap-2 bg-white p-2 rounded border", children: [e.jsx("code", { className: "flex-1 text-sm text-gray-700 text-center", children: `https://magoka.food/r/${a.referralCode}` }), e.jsx(d, { size: "sm", variant: "outline", onClick: o, className: "px-2", children: e.jsx(X, { className: "h-4 w-4" }) })] }), e.jsxs(d, { className: "w-full mt-3 bg-green-600 hover:bg-green-700", onClick: c, children: [e.jsx(Z, { className: "h-4 w-4 mr-2" }), "Share & Earn ", C((n == null ? void 0 : n.amountInNaira) || 2e3)] })] })] }) }), e.jsxs(g, { children: [e.jsx(L, { children: e.jsx(K, { children: "Quick Actions" }) }), e.jsxs(b, { className: "space-y-3", children: [e.jsx(u, { href: "/profile/edit", children: e.jsxs(d, { variant: "outline", className: "w-full justify-start", children: [e.jsx(ae, { className: "h-4 w-4 mr-2" }), "View Profile Details"] }) }), e.jsx(u, { href: "/wallet", children: e.jsxs(d, { variant: "outline", className: "w-full justify-start", children: [e.jsx(D, { className: "h-4 w-4 mr-2" }), "magoka Wallet"] }) }), e.jsx(u, { href: "/points", children: e.jsxs(d, { variant: "outline", className: "w-full justify-start", children: [e.jsx(ee, { className: "h-4 w-4 mr-2" }), "magoka Points"] }) }), e.jsx(u, { href: "/share-earn", children: e.jsxs(d, { variant: "outline", className: "w-full justify-start", children: [e.jsx(S, { className: "h-4 w-4 mr-2" }), "Share & Earn"] }) }), e.jsx(V, {}), e.jsx(u, { href: "/my-orders", children: e.jsxs(d, { variant: "outline", className: "w-full justify-start", children: [e.jsx(A, { className: "h-4 w-4 mr-2" }), "My Orders"] }) })] })] })] })] });
}
