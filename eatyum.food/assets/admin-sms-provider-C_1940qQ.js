...
function ve() {
  const [a, j] = n.useState(null), [y, b] = n.useState(true), [S, f] = n.useState(false), [v, g] = n.useState(false), [o, C] = n.useState(""), [l, T] = n.useState("Test SMS from EatYum platform"), { toast: r } = R();
  n.useEffect(() => {
    I();
  }, []);
