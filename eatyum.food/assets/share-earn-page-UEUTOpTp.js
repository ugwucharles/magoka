...
function ie() {
  ...
  const g = () => a != null && a.referralCode ? `https://eatyum.food/r/${a.referralCode}` : "", d = () => __async(null, null, function* () {
    const r = g();
    if (r) try {
    ...
    const r = g();
    if (!r) return;
    const c = `Join EatYum and get ${i((s == null ? void 0 : s.amountInNaira) || 2e3)} bonus! Use my referral link to sign up and get ${i((s == null ? void 0 : s.amountInNaira) || 2e3)} bonus after your first order of \u20A61500+`;
    if (navigator.share) try {
      yield navigator.share({ title: `Join EatYum and get ${i((s == null ? void 0 : s.amountInNaira) || 2e3)} bonus!`, text: c, url: r });
    } catch (e2) {
      d();
    }
    else try {
