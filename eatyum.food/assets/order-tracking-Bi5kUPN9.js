...
}, ge = "https://play.google.com/store/apps/details?id=com.exolvemedia.naijarecipes&hl=en", ve = "https://apps.apple.com/ng/app/magoka-food/id6615071543", be = (s, m, a) => s === "ios" && a ? a : s === "android" && m ? m : m || a, Ne = ({ brandName: s, playStoreUrl: m, appStoreUrl: a }) => {
  if (!m && !a) return null;
...
function as() {
  ...
  U();
  const { data: n } = se(), i = (_a = n == null ? void 0 : n.name) != null ? _a : "magoka", v = g.useMemo(() => n != null && n.domain ? `https://${n.domain}` : window.location.origin.replace(/\/$/, ""), [n == null ? void 0 : n.domain]), f = (_b = n == null ? void 0 : n.playStoreUrl) != null ? _b : n ? void 0 : ge, x = (_c = n == null ? void 0 : n.appStoreUrl) != null ? _c : n ? void 0 : ve, A = !!(f || x), { data: r, isLoading: C, error: h } = I({ queryKey: ["/api/orders", c, "track"], queryFn: () => __async(null, null, function* () {
