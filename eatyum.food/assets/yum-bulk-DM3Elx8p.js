...
function Ss() {
  ...
  const p = (s == null ? void 0 : s.colorScheme) || "#006400", Re = (s == null ? void 0 : s.name) || "YumBulk", me = c.useMemo(() => {
    const t = !s || s.name === "magoka" ? "/magoka-logo.png" : "/logo.png", r = (s == null ? void 0 : s.logoLightUrl) || (s == null ? void 0 : s.logoDarkUrl) || (s == null ? void 0 : s.logoUrl) || t, l = (s == null ? void 0 : s.logoDarkUrl) || r;
